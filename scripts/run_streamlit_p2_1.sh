...
keys = [
    ...
    "TCO_VELOCITY_SNAPSHOT_REFRESH_QUERY_TIMEOUT",
    "TCO_SETTINGS_EXPLORER_QUERY_TIMEOUT",
]
...
export TCO_VELOCITY_SNAPSHOT_REFRESH_QUERY_TIMEOUT="${TCO_VELOCITY_SNAPSHOT_REFRESH_QUERY_TIMEOUT:-120}"
export TCO_SETTINGS_EXPLORER_QUERY_TIMEOUT="${TCO_SETTINGS_EXPLORER_QUERY_TIMEOUT:-90}"
...
echo "TCO_VELOCITY_SNAPSHOT_REFRESH_QUERY_TIMEOUT=${TCO_VELOCITY_SNAPSHOT_REFRESH_QUERY_TIMEOUT}"
echo "TCO_SETTINGS_EXPLORER_QUERY_TIMEOUT=${TCO_SETTINGS_EXPLORER_QUERY_TIMEOUT}"
